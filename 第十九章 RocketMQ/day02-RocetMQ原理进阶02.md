...
![01_RocketMQ网络拓扑图架构](01_RocketMQ网络拓扑图架构.png)

![02_RocketMQ消息存储及刷盘策略](02_RocketMQ消息存储及刷盘策略.png)

![03_RocketMQ顺序性消息](03_RocketMQ顺序性消息.png)

![04_RocketMQ消息去重](04_RocketMQ消息去重.png)

![05_RocketMQ延迟消息](05_RocketMQ延迟消息.png)

![06_RocketMQ消息可靠性](06_RocketMQ消息可靠性.png)
...
定时消息是指消息发送到 Broker 后，不能立刻被 Consumer 消费，要到特定的时间点或者等待特定的时间后才能被消费。 RocketMQ 支持延时消息，但是不支持任意时间精度，支持特定的 level，例如定
